    ...
    >
      ...
      <div className="p-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-full px-4 py-3 bg-primary text-primary-foreground font-medium rounded-md hover:bg-primary-hover hover:text-primary-foreground transition-all duration-200 group-hover:shadow-md"
        >
          {buttonText}
